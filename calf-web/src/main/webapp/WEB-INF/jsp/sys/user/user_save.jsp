        ...
        <div class="box-body">
            <table class="no-padding no-margin form-table">
                ...
                <tr>
                    ...
                    <td class="body-input"><input type="text" class="form-control input-sm" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'twoer'})" name="birthday" id="birthday"></td>
