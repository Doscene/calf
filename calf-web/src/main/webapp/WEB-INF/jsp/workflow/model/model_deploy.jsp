...
<div class="box">
    <form id="workflow-model-save-form" autocomplete="off">
        <div class="box-header with-border">
            <h3 class="box-title">工作流模型-部署</h3>
            <div class="pull-right">
                <button type="button" class="btn btn-default btn-flat  btn-sm"
                        onclick="submitModel()"><i class="fa fa-save text-aqua"></i>&nbsp;部署
                </button>
        ...
        <div class="box-body">
            <div class="form-group no-padding form-inline">
                ...
                <div class="input-group col-sm-3">
                    ...
                    <input type="text" class="form-control input-sm" name="name" id="name" value="${model.name}">
                </div>
                <div class="input-group col-sm-offset-1 col-sm-3">
                    <label for="key" class="input-group-addon">
                        流程定义键
                    </label>
                    <input type="text" class="form-control input-sm" name="key" id="key" value="${model.key}">
                </div>
            </div>
        </div>
    </form>
