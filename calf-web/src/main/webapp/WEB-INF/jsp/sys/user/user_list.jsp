    ...
    <div class="col-xs-12">
        <div class="box">
                ...
                <form id="sys-user-table-search-form" class="form-inline no-padding no-margin" role="form">
                    <div class="pull-left">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="trueName" class="form-control input-sm" id="true-name">
                        </div>
                        <div class="form-group">
            ...
            <div class="box-body no-padding">
                <table id="sys-user-table" class="table table-condensed table-striped table-bordered table-hover"></table>
            </div>
        </div>
    </div>
</div>
        ...
        columns: [
            ...
            {data: 'createBy', title: '创建人'},
            {
                ...
                render: function (data) {
                    ...
                    var grantBtn = '&nbsp;<button class="btn btn-sm btn-default btn-flat" onclick="openChildWindow(\'sys/user/toUserGrant\',\'用户管理-授权\')"><i class="fa fa-cog text-yellow"></i>&nbsp;授权</button>';
                    var deleteBtn = '&nbsp;<button class="btn btn-sm btn-default btn-flat" onclick="deleteUser(\'' + data['loginName'] + '\',this)"><i class="fa fa-trash text-red"></i>&nbsp;删除</button>';
                    ...
                    return editBtn +grantBtn+ deleteBtn + viewBtn;
                }
                , width: '20%',
                title: '操作'
            }
