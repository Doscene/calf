    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <form id="workflow-processdef-table-search-form" class="form-inline no-padding no-margin" role="form">
                    <div class="pull-left">
            ...
            <div class="box-body no-padding">
                <table id="workflow-processdef-table"
...
<script>
    var dataTable = $('#workflow-processdef-table').DataTable({
        paging: true, //开启分页
        ...
        ajax: function (data, callback) {
            ...
            $.ajax({
                type: "get",
                url: 'workflow/processdef/pageList',
                cache: false,
                data: $('#workflow-processdef-table-search-form').serialize() + '&pageNum=' + pageNum + '&pageSize=' + data.length,
                dataType: "json"
        ...
        columns: [
            {data: 'name', title: '流程名称'},
            {data: 'key', title: '流程定义KEY'},
            ...
            {data: 'revision', title: '校订版本'},
            {
                ...
                render: function (data) {
                    var design = '<button class="btn btn-sm btn-default btn-flat" onclick="openChildWindow(\'modeler.html?modelId=' + data['id'] + '\',\'工作流模型设计\')"><i class="fa fa-play text-yellow"></i>&nbsp;启动流程</button>';
                    var history = '&nbsp;<button class="btn btn-sm btn-default btn-flat"><i class="fa fa-history text-red"></i>&nbsp;历史版本</button>';
